...
call s:Col('Identifier', 'base6')
call s:Col('Function', 'yellow')
call s:Col('Keyword', 'green')
call s:Col('Operator', 'orange')
call s:Col('Delimiter', 'red')
call s:Col('Type', 'magenta')
